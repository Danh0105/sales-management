/**
 * Seed TKB Kỹ năng công dân số — Trường Tiểu học Tân Hiệp, năm học 2026-2027.
 *
 * Nhập từ bảng TKB giấy: một giáo viên duy nhất (Võ Nguyễn Thành Nam) dạy 20 lớp
 * trong 21 tiết/tuần — lớp 4.2 có 2 tiết (sáng Thứ 5 và sáng Thứ 6), còn lại
 * mỗi lớp 1 tiết. Sáng chỉ có Thứ 5 và Thứ 6; chiều đủ Thứ 2 → Thứ 6.
 *
 ...
 *
 * Chạy: npm run seed:tkb-tan-hiep
 */
...
const SCHOOL_NAME_LIKE = '%TÂN HIỆP%';
const SCHOOL_YEAR = '2026-2027';
const SUBJECT_NAME = 'Công dân số';
const SUBJECT_CATALOG_ID = 17;

/** Giáo viên "Thành Nam" trong bảng TKB — chốt theo id cho chắc. */
const TEACHER_ID = 166;
const TEACHER_NAME = 'Võ Nguyễn Thành Nam';
...
const SLOTS: Slot[] = [
    // ===== SÁNG =====
    { session: 'morning', period: 1, dayOfWeek: 5, className: '2.2' },

    { session: 'morning', period: 2, dayOfWeek: 5, className: '4.2' },

    { session: 'morning', period: 3, dayOfWeek: 5, className: '3.4' },
    { session: 'morning', period: 3, dayOfWeek: 6, className: '4.2' },

    { session: 'morning', period: 4, dayOfWeek: 5, className: '3.2' },
    { session: 'morning', period: 4, dayOfWeek: 6, className: '1.3' },

    // ===== CHIỀU =====
    { session: 'afternoon', period: 1, dayOfWeek: 2, className: '2.1' },
    { session: 'afternoon', period: 1, dayOfWeek: 3, className: '3.3' },
    { session: 'afternoon', period: 1, dayOfWeek: 4, className: '5.3' },
    { session: 'afternoon', period: 1, dayOfWeek: 5, className: '4.4' },
    { session: 'afternoon', period: 1, dayOfWeek: 6, className: '4.1' },

    { session: 'afternoon', period: 2, dayOfWeek: 2, className: '1.1' },
    { session: 'afternoon', period: 2, dayOfWeek: 3, className: '2.3' },
    { session: 'afternoon', period: 2, dayOfWeek: 4, className: '1.4' },
    { session: 'afternoon', period: 2, dayOfWeek: 5, className: '2.4' },
    { session: 'afternoon', period: 2, dayOfWeek: 6, className: '5.2' },

    { session: 'afternoon', period: 3, dayOfWeek: 2, className: '1.2' },
    { session: 'afternoon', period: 3, dayOfWeek: 3, className: '5.1' },
    { session: 'afternoon', period: 3, dayOfWeek: 4, className: '4.3' },
    { session: 'afternoon', period: 3, dayOfWeek: 5, className: '3.1' },
    { session: 'afternoon', period: 3, dayOfWeek: 6, className: '5.4' },
];
